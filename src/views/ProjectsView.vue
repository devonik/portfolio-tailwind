  ...
  <main>
    <div class="flex flex-center">
      <div class="max-w-md mx-auto">
        <h3 class="text-2xl">Playground</h3>
        ...
        <div
          ...
          <div class="md:flex-shrink-0 md:p-8 md:pr-0">
            <img class="w-full object-cover md:rounded-xl md:w-48" src="@/assets/projects/yogagraphy-logo.png"
              alt="Yogagraphy">
          </div>
          <div class="p-8">
            ...
            <div class="mb-3">
              ...
              <span class="icon-[logos--docker-icon] mr-3" title="VueJs" style="width: 32px; height: 32px;"></span>
            </div>
          </div>
        </div>
      ...
      <div>
        <h3 class="text-2xl">Project history</h3>
        <!-- Company history -->
        <div class="mb-6">
          <div
            class="max-w-md mx-auto mb-3 bg-white dark:bg-gray-800 md:rounded-xl shadow-md overflow-hidden md:max-w-2xl">
          ...
          <div
            ...
            <div class="md:flex">
              <div class="md:flex-shrink-0 md:p-8 md:pr-0">
                <img class="w-full object-cover md:rounded-xl md:w-48" src="@/assets/projects/upljft-logo.png"
                  alt="Upljft">
              </div>
              <div class="p-8">
